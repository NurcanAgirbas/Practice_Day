...
//  ! Then output: sam john tom
    ...
    public void acceptString(String str1, String str2, String str3) {
        // Storing multiple strings into the array
        String[] array = { str1, str2, str3 };
        System.out.println(Arrays.toString(array));
    }
    
    public void acceptString2(String name1, String name2, String name3) {
