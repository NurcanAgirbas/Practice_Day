...
//		output = "there is 1 “com” in sentences "
		...
		System.out.println("Please enter a String to find occurence");
		...
		System.out.println("There are " + count + " " + word + "is in the sentences");
		
		
		}else if(count==1) {
			System.out.println("There is 1" + word + "in the sentences");
		}
		System.out.println("There is any " + word + "in the sentences");
	}
